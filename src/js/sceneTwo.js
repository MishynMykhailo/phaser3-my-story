...
//////////--------music
 this.sound.add('myStorySound').play()
...
//////////--------player man/woman - animation
    ...
    const womanPlayer = this.add.sprite(-750,0,'woman-sprite').setOrigin(0,0);
    const manText= this.add.image(300,450,'manPlayer-talk').setScale(0.0);
    const playerContainer = this.add.container(0,0,[manPlayer,manText,womanPlayer]);
    const womanText =this.add.image(300,450,'womanPlayer-talk').setScale(0.0);
    const finallyTextTrue = this.add.image(300,500,'finally-Text-True').setScale(0)
...
//------------------------->face-woman-anim-№3
    ...
    this.tweens.add({
        ...
        /// woman-text-anim-4
    const womenTextTweens = this.tweens.add({
        targets: womanText,
        delay:400,
        duration:500,
        scaleX:0.3,
    ...
    const finallyTextTrueTweens = this.tweens.add({
    ...
    const womenScaleAnim = this.tweens.add({
        targets:womanPlayer,
        delay:400,
        duration:500,
        scaleX:1.2,
    ...
    const playerChangePosition = this.tweens.add({
        delay:400,
    ...
    const manFinallSceneAnimation = this.tweens.add({
        delay:400,
        targets: manPlayer,
        duration: 700,
        repeat: 0,
...
//////////--------BUTTON
///button-anims 
const buttonFirstAnim = this.tweens.add({
    delay:400,
...
const buttonHiddenFirstAnim = this.tweens.add({
    targets:[allBtn.buttonFirstRight,allBtn.buttonFirstLeft],
...
const buttonTwoAnim = this.tweens.add({
    delay:400,
...
allBtn.buttonTwoRight.on('pointerup', hoverButtonTwoRight, this)
.on('pointerover',()=>{
    this.tweens.add({
...
allBtn.buttonTwoLeft.on('pointerup', hoverButtonTwoLeft, this)
.on('pointerover',()=>{
    this.tweens.add({
...
const buttonTwoHiddenAnim = this.tweens.add({
    targets:[allBtn.buttonTwoRight,allBtn.buttonTwoLeft],
...
const buttonTreeAnim = this.tweens.add({
    delay:400,
...
allBtn.buttonTreeRight.on('pointerup', hoverButtonTreeRight, this)
.on('pointerover',()=>{
    this.tweens.add({
...
allBtn.buttonTreeLeft.on('pointerup', hoverButtonTreeLeft, this)
.on('pointerover',()=>{
    this.tweens.add({
...
const buttonTreeHiddenAnim = this.tweens.add({
    targets:[allBtn.buttonTreeRight,allBtn.buttonTreeLeft],
...
const buttonFourAnim = this.tweens.add({
    delay:400,
...
allBtn.buttonFourRight.on('pointerup', hoverButtonFourRight, this)
.on('pointerover',()=>{
    this.tweens.add({
...
const buttonFourHiddenAnim = this.tweens.add({
    targets:[allBtn.buttonFourRight,allBtn.buttonFourLeft],
    duration:250,
    scaleX:0,
    scaleY:0
}).pause();
allBtn.buttonFourLeft.on('pointerup', hoverButtonFourLeft, this)
.on('pointerover',()=>{
    this.tweens.add({
...
//////////--------HAND-ERROR
 ...
 const handErrorTweens = this.tweens.add({ 
    targets:handError,
     delay:2000,
     duration:1000,
     repeat: -1,
...
const handErrorScaleTweens = this.tweens.add({
    targets:handError,
    delay:2000,
    duration:500,
    scaleX:0.5,
...
const handErrorHiddenTweens = this.tweens.add({
    targets:handError,
    duration:100,
    scaleX:0,
    scaleY:0,
